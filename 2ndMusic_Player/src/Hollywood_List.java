...
public class Hollywood_List extends JFrame{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Hollywood_List window = new Hollywood_List();
	 ...
	 */
	public Hollywood_List() {
		Hframe= new JFrame();
		Hframe.setBounds(500, 300, 861, 532);
		Hframe.getContentPane().setBackground(SystemColor.inactiveCaptionBorder);
		...
		Hframe.getContentPane().add(pnlHeader);
		...
		Hframe.getContentPane().add(pnlHeaderTrack);
		...
		Hframe.getContentPane().add(pane);
	...
	void funList()
	{
		...
		try
		{
			...
			String query = "select song,song_name,artist from songs_list where caterory = 'Hollywood' and email='"+email+"' ";
