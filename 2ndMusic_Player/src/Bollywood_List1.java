...
public class Bollywood_List1 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Bollywood_List1 window = new Bollywood_List1();
	 ...
	 */
	public Bollywood_List1() {
		Bframe= new JFrame();
		Bframe.setBounds(500, 300, 861, 532);
		Bframe.getContentPane().setBackground(SystemColor.inactiveCaptionBorder);
		...
		Bframe.getContentPane().add(pnlHeader);
		...
		btnClose.setBounds(779, 5, 72, 40);
		...
		Bframe.getContentPane().add(pnlHeaderTrack);
		...
		Bframe.getContentPane().add(pane);
		...
		try
		{
		    ...
		    Connection con = DriverManager.getConnection(url, "root", "rutu2012089");
              ...
              String email=AccessEmail.getEmailId();
    			String query = "select song,song_name,artist from songs_list where caterory = 'Bollywood' and email='"+email+"' ";
